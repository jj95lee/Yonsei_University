...
for idx = 1:11
    ...
    axis square
     ...
     quiver3(-1, 0, 0, 2, 0, 0, 'Color', 'black') % , 'Color', 'black', 'LineWidth', 2
     quiver3(0, -1, 0, 0, 2, 0, 'Color', 'black') % , 'Color', 'black', 'LineWidth', 2
     quiver3(0, 0, -1, 0, 0, 2, 'Color', 'black') % , 'Color', 'black', 'LineWidth', 2
    ...
    quiver3(0, 0, 0, x(1), x(2), x(3), 'Color', [0.8510 0.3294 0.1020])
    quiver3(0, 0, 0, y(1), y(2), y(3), 'Color', [0.4706 0.6706 0.1882])
    quiver3(0, 0, 0, z(1), z(2), z(3), 'Color', [0.0000 0.4510 0.7412])
...
for idx = 1:11
    ...
    quiver3(-1, 0, 0, 2, 0, 0, 'Color', 'black')
    quiver3(0, -1, 0, 0, 2, 0, 'Color', 'black')
    quiver3(0, 0, -1, 0, 0, 2, 'Color', 'black')
