...
% 서울 저각도(68) - Freeflyer를 통해 얻은 Access Profile
ff_00 = ...
[...
...
% 서울 고각도(59) - Freeflyer를 통해 얻은 Access Profile
gg_00 = ...
[...
...
% 블라디 저각도(62) - Freeflyer를 통해 얻은 Access Profile
hh_00 = ...
[...
...
% 블라디 고각도(65) - Freeflyer를 통해 얻은 Access Profile
ii_00 = ...
[...
...
%% K_Satellite Setting(H2 / L0) - 기준 위성의 위치를 바탕으로 고각도 위성 1대 배치(총 2대) [서울]
...
Cov_kh1 = length(integer_intervals_kh1)/L*100;

%% E_Satellite Setting(H2 / L0) - 기준 위성의 위치를 바탕으로 고각도 위성 1대 배치(총 2대) [블라디보스토크]
...
%%
%% K_Satellite Setting(H3 / L0) - 앞에서 배치한 두 위성의 위치를 바탕으로 고각도 위성 1대 추가 배치(총 3대) [서울]
...
integer_intervals_kh3 = [];
   ...
   % 고각도 satellite 2 위치 생성
       interval_kh2 = interval_kh1 + random_number_1; 
       interval_kh2(interval_kh2 > (L-1)) = interval_kh2(interval_kh2 > (L-1)) - L;
       integer_intervals_kh2 = [integer_intervals_kh2, interval_kh2];

   % 고각도 satellite 3 랜덤 위치 생성
...
%% E_Satellite Setting(H3 / L0) - 앞에서 배치한 두 위성의 위치를 바탕으로 고각도 위성 1대 추가 배치(총 3대) [블라디보스토크]
...
%%
%% K_Satellite Setting(H4 / L0) - 앞의 과정과 동일하게 위성을 한 대씩 추가로 배치
...
integer_intervals_kh4 = [];
   ...
   % 고각도 satellite 3 위치 생성
       interval_kh3 = interval_kh1 + random_number_2; 
       interval_kh3(interval_kh3 > (L-1)) = interval_kh3(interval_kh3 > (L-1)) - L;
       integer_intervals_kh3 = [integer_intervals_kh3, interval_kh3];

   % 고각도 satellite 4 랜덤 위치 생성
...
integer_intervals_kh5 = [];
   ...
   % 고각도 satellite 4 위치 생성
       interval_kh4 = interval_kh1 + random_number_3; 
       interval_kh4(interval_kh4 > (L-1)) = interval_kh4(interval_kh4 > (L-1)) - L;
       integer_intervals_kh4 = [integer_intervals_kh4, interval_kh4];

   % 고각도 satellite 5 랜덤 위치 생성
...
integer_intervals_kh5 = [];
   ...
   % 고각도 satellite 1 위치 생성
   interval_kh1 = start_points2(i) :end_points2(i) ;
       interval_kh1(interval_kh1 > (L-1)) = interval_kh1(interval_kh1 > (L-1)) - 7320; 
       integer_intervals_kh1 = [integer_intervals_kh1, interval_kh1];
...
integer_intervals_kh6 = [];
   ...
   % 고각도 satellite 5 위치 생성
       interval_kh5 = interval_kh1 + random_number_4; 
       interval_kh5(interval_kh5 > (L-1)) = interval_kh5(interval_kh5 > (L-1)) - L;
       integer_intervals_kh5 = [integer_intervals_kh5, interval_kh5];

   % 고각도 satellite 6 위치 생성
...
integer_intervals_kh8 = [];
   ...
   % 고각도 satellite 7 위치 생성
       interval_kh7 = interval_kh1 + random_number_6; 
       interval_kh7(interval_kh7 > (L-1)) = interval_kh7(interval_kh7 > (L-1)) - L;
       integer_intervals_kh7 = [integer_intervals_kh7, interval_kh7];

   % 고각도 satellite 8 랜덤 위치 생성
...
integer_intervals_kh9 = [];
   ...
   % 고각도 satellite 8 위치 생성
       interval_kh8 = interval_kh1 + random_number_7; 
       interval_kh8(interval_kh8 > (L-1)) = interval_kh8(interval_kh8 > (L-1)) - L;
       integer_intervals_kh8 = [integer_intervals_kh8, interval_kh8];

   % 고각도 satellite 9 랜덤 위치 생성
...
integer_intervals_kh10 = [];
   ...
   % 고각도 satellite 9 위치 생성
       interval_kh9 = interval_kh1 + random_number_8; 
       interval_kh9(interval_kh9 > (L-1)) = interval_kh9(interval_kh9 > (L-1)) - L;
       integer_intervals_kh9 = [integer_intervals_kh9, interval_kh9];

   % 고각도 satellite 10 랜덤 위치 생성
...
%%
%% K_Satellite Setting(H10 / L1) - 고각도 위성의 위치를 바탕으로 저각도 위성 1대 배치(총 11대) [서울]
...
integer_intervals_kL1 = [];
   ...
   for i = 1:length(ff_0)
   % 저각도 satellite 0 위치 생성
       interval_kL0 = start_points1(i) :end_points1(i) ;
       interval_kL0(interval_kL0 > (L-1)) = interval_kL0(interval_kL0 > (L-1)) - L; 
       integer_intervals_kL0 = [integer_intervals_kL0, interval_kL0];

   % 저각도 satellite 1 위치 생성
       interval_kL1 = interval_kL0 + n; 
       interval_kL1(interval_kL1 > (L-1)) = interval_kL1(interval_kL1 > (L-1)) - L;
...
%% E_Satellite Setting(H10 / L1) - 고각도 위성의 위치를 바탕으로 저각도 위성 1대 배치(총 11대) [블라디보스토크]
...
integer_intervals_eL1 = [];
   ...
   % 저각도 satellite 0 위치 생성
       ...
       interval_eL0(interval_eL0 > (L-1)) = interval_eL0(interval_eL0 > (L-1)) - L; 
       integer_intervals_eL0 = [integer_intervals_eL0, interval_eL0];

   % 저각도 satellite 1 랜덤 위치 생성
       interval_eL1 = interval_eL0 + n; 
       interval_eL1(interval_eL1 > (L-1)) = interval_eL1(interval_eL1 > (L-1)) - L;
...
integer_intervals_kL1 = [];
   ...
   % 저각도 satellite 1 위치 생성
       interval_kL1 = interval_kL0 + random_number_10; 
       interval_kL1(interval_kL1 > (L-1)) = interval_kL1(interval_kL1 > (L-1)) - L;
       integer_intervals_kL1 = [integer_intervals_kL1, interval_kL1];
   end
...
integer_intervals_eL1 = [];
   ...
   % 저각도 satellite 1 위치 생성
       interval_eL1 = interval_eL0 + random_number_10; 
       interval_eL1(interval_eL1 > (L-1)) = interval_eL1(interval_eL1 > (L-1)) - L;
       integer_intervals_eL1 = [integer_intervals_eL1, interval_eL1];
   end
...
%%
%% K_Satellite Setting(H10 / L2) - 반복하여 저각도 위성 추가로 배치
...
integer_intervals_kL2 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 2 위치 생성
       interval_kL2 = interval_kL0 + n; 
       interval_kL2(interval_kL2 > (L-1)) = interval_kL2(interval_kL2 > (L-1)) - L;
...
integer_intervals_eL2 = [];
   ...
   % 저각도 satellite 1 랜덤 위치 생성
       ...
       interval_eL2(interval_eL2 > (L-1)) = interval_eL2(interval_eL2 > (L-1)) - L;
...
integer_intervals_kL2 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 2 위치 생성
       interval_kL2 = interval_kL0 + random_number_11; 
       interval_kL2(interval_kL2 > (L-1)) = interval_kL2(interval_kL2 > (L-1)) - L;
       integer_intervals_kL2 = [integer_intervals_kL2, interval_kL2];
   end
...
Cov_kh10_2 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL2 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       integer_intervals_eL1 = [integer_intervals_eL1, interval_eL1];
        ...
        % 저각도 satellite 2 위치 생성
       interval_eL2 = interval_eL0 + random_number_11; 
       interval_eL2(interval_eL2 > (L-1)) = interval_eL2(interval_eL2 > (L-1)) - L;
       integer_intervals_eL2 = [integer_intervals_eL2, interval_eL2];
   end
...
Cov_eh10_2 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H10 / L3)
...
integer_intervals_kL3 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 3 위치 생성
       interval_kL3 = interval_kL0 + n; 
       interval_kL3(interval_kL3 > (L-1)) = interval_kL3(interval_kL3 > (L-1)) - L;
...
integer_intervals_eL3 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       interval_eL3(interval_eL3 > (L-1)) = interval_eL3(interval_eL3 > (L-1)) - L;
...
integer_intervals_kL3 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 3 위치 생성
       interval_kL3 = interval_kL0 + random_number_12; 
       interval_kL3(interval_kL3 > (L-1)) = interval_kL3(interval_kL3 > (L-1)) - L;
       integer_intervals_kL3 = [integer_intervals_kL3, interval_kL3];
   end
...
Cov_kh10_3 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL3 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 3 위치 생성
       interval_eL3 = interval_eL0 + random_number_12; 
       interval_eL3(interval_eL3 > (L-1)) = interval_eL3(interval_eL3 > (L-1)) - L;
       integer_intervals_eL3 = [integer_intervals_eL3, interval_eL3];
   end
...
Cov_eh10_3 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H10 / L4)
...
integer_intervals_kL4 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 4 위치 생성
       interval_kL4 = interval_kL0 + n; 
       interval_kL4(interval_kL4 > (L-1)) = interval_kL4(interval_kL4 > (L-1)) - L;
...
integer_intervals_eL4 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       interval_eL4(interval_eL4 > (L-1)) = interval_eL4(interval_eL4 > (L-1)) - L;
...
integer_intervals_kL4 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 4 위치 생성
       interval_kL4 = interval_kL0 + random_number_13; 
       interval_kL4(interval_kL4 > (L-1)) = interval_kL4(interval_kL4 > (L-1)) - L;
       integer_intervals_kL4 = [integer_intervals_kL4, interval_kL4];
   end
...
Cov_kh10_4 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL4 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 4 위치 생성
       interval_eL4 = interval_eL0 + random_number_13; 
       interval_eL4(interval_eL4 > (L-1)) = interval_eL4(interval_eL4 > (L-1)) - L;
       integer_intervals_eL4 = [integer_intervals_eL4, interval_eL4];
   end
...
Cov_eh10_4 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H10 / L5)
...
integer_intervals_kL5 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 5 위치 생성
       interval_kL5 = interval_kL0 + n; 
       interval_kL5(interval_kL5 > (L-1)) = interval_kL5(interval_kL5 > (L-1)) - L;
...
integer_intervals_eL5 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       interval_eL5(interval_eL5 > (L-1)) = interval_eL5(interval_eL5 > (L-1)) - L;
...
integer_intervals_kL5 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 5 위치 생성
       interval_kL5 = interval_kL0 + random_number_14; 
       interval_kL5(interval_kL5 > (L-1)) = interval_kL5(interval_kL5 > (L-1)) - L;
       integer_intervals_kL5 = [integer_intervals_kL5, interval_kL5];
   end
...
Cov_kh10_5 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL5 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 5 위치 생성
       interval_eL5 = interval_eL0 + random_number_14; 
       interval_eL5(interval_eL5 > (L-1)) = interval_eL5(interval_eL5 > (L-1)) - L;
       integer_intervals_eL5 = [integer_intervals_eL5, interval_eL5];
   end
...
Cov_eh10_5 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H10 / L6)
...
integer_intervals_kL6 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 6 위치 생성
       interval_kL6 = interval_kL0 + n; 
       interval_kL6(interval_kL6 > (L-1)) = interval_kL6(interval_kL6 > (L-1)) - L;
...
integer_intervals_eL6 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       interval_eL6(interval_eL6 > (L-1)) = interval_eL6(interval_eL6 > (L-1)) - L;
...
integer_intervals_kL6 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 6 위치 생성
       interval_kL6 = interval_kL0 + random_number_15; 
       interval_kL6(interval_kL6 > (L-1)) = interval_kL6(interval_kL6 > (L-1)) - L;
       integer_intervals_kL6 = [integer_intervals_kL6, interval_kL6];
   end
...
Cov_kh10_6 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL6 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 6 위치 생성
       interval_eL6 = interval_eL0 + random_number_15; 
       interval_eL6(interval_eL6 > (L-1)) = interval_eL6(interval_eL6 > (L-1)) - L;
       integer_intervals_eL6 = [integer_intervals_eL6, interval_eL6];
   end
...
Cov_eh10_6 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H10 / L7)
...
integer_intervals_kL7 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 7 위치 생성
       interval_kL7 = interval_kL0 + n; 
       interval_kL7(interval_kL7 > (L-1)) = interval_kL7(interval_kL7 > (L-1)) - L;
...
integer_intervals_eL7 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       interval_eL7(interval_eL7 > (L-1)) = interval_eL7(interval_eL7 > (L-1)) - L;
...
integer_intervals_kL7 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 7 위치 생성
       interval_kL7 = interval_kL0 + random_number_16; 
       interval_kL7(interval_kL7 > (L-1)) = interval_kL7(interval_kL7 > (L-1)) - L;
       integer_intervals_kL7 = [integer_intervals_kL7, interval_kL7];
   end
...
Cov_kh10_7 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL7 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 7 위치 생성
       interval_eL7 = interval_eL0 + random_number_16; 
       interval_eL7(interval_eL7 > (L-1)) = interval_eL7(interval_eL7 > (L-1)) - L;
       integer_intervals_eL7 = [integer_intervals_eL7, interval_eL7];
   end
...
Cov_eh10_7 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H10 / L8)
...
integer_intervals_kL8 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 8 위치 생성
       interval_kL8 = interval_kL0 + n; 
       interval_kL8(interval_kL8 > (L-1)) = interval_kL8(interval_kL8 > (L-1)) - L;
...
integer_intervals_eL8 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       interval_eL8(interval_eL8 > (L-1)) = interval_eL8(interval_eL8 > (L-1)) - L;
...
integer_intervals_kL8 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 8 위치 생성
       interval_kL8 = interval_kL0 + random_number_17; 
       interval_kL8(interval_kL8 > (L-1)) = interval_kL8(interval_kL8 > (L-1)) - L;
       integer_intervals_kL8 = [integer_intervals_kL8, interval_kL8];
   end
...
Cov_kh10_8 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL8 = [];
   ...
   % 저각도 satellite 1 위치 생성
       ...
       % 저각도 satellite 8 위치 생성
       interval_eL8 = interval_eL0 + random_number_17; 
       interval_eL8(interval_eL8 > (L-1)) = interval_eL8(interval_eL8 > (L-1)) - L;
       integer_intervals_eL8 = [integer_intervals_eL8, interval_eL8];
   end
...
Cov_eh10_8 = length(unique_intervals_eh) / L * 100;
...
%% figure3 : 새로운 그래프에 두 개의 플롯을 함께 보기
figure3 = figure;
subplot(3, 1, 1);
...
%% figure 6 : 새로운 그래프에 두 개의 플롯을 함께 보기
figure3 = figure;
subplot(3, 1, 1);
