...
Cov_kh8_1 = length(unique_intervals_kh) / L * 100;
...
Cov_eh8_1 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L2)
...
Cov_kh8_2 = length(unique_intervals_kh) / L * 100;
...
Cov_eh8_2 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L3)
...
Cov_kh8_3 = length(unique_intervals_kh) / L * 100;
...
Cov_eh8_3 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L4)
...
integer_intervals_kL4 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 4 위치 생성
       interval_kL4 = interval_kL0 + random_number_11; 
       interval_kL4(interval_kL4 > (L-1)) = interval_kL4(interval_kL4 > (L-1)) - L;
       integer_intervals_kL4 = [integer_intervals_kL4, interval_kL4];
   end
...
Cov_kh8_4 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL4 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 4 위치 생성
       interval_eL4 = interval_eL0 + random_number_11; 
       interval_eL4(interval_eL4 > (L-1)) = interval_eL4(interval_eL4 > (L-1)) - L;
       integer_intervals_eL4 = [integer_intervals_eL4, interval_eL4];
   end
...
Cov_eh8_4 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L5)
...
integer_intervals_kL5 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 5 위치 생성
       interval_kL5 = interval_kL0 + random_number_12; 
       interval_kL5(interval_kL5 > (L-1)) = interval_kL5(interval_kL5 > (L-1)) - L;
       integer_intervals_kL5 = [integer_intervals_kL5, interval_kL5];
   end
...
Cov_kh8_5 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL5 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 5 위치 생성
       interval_eL5 = interval_eL0 + random_number_12; 
       interval_eL5(interval_eL5 > (L-1)) = interval_eL5(interval_eL5 > (L-1)) - L;
       integer_intervals_eL5 = [integer_intervals_eL5, interval_eL5];
   end
...
Cov_eh8_5 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L6)
...
integer_intervals_kL6 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 6 위치 생성
       interval_kL6 = interval_kL0 + random_number_13; 
       interval_kL6(interval_kL6 > (L-1)) = interval_kL6(interval_kL6 > (L-1)) - L;
       integer_intervals_kL6 = [integer_intervals_kL6, interval_kL6];
   end
...
Cov_kh8_6 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL6 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 6 위치 생성
       interval_eL6 = interval_eL0 + random_number_13; 
       interval_eL6(interval_eL6 > (L-1)) = interval_eL6(interval_eL6 > (L-1)) - L;
       integer_intervals_eL6 = [integer_intervals_eL6, interval_eL6];
   end
...
Cov_eh8_6 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L7)
...
integer_intervals_kL7 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 7 위치 생성
       interval_kL7 = interval_kL0 + random_number_14; 
       interval_kL7(interval_kL7 > (L-1)) = interval_kL7(interval_kL7 > (L-1)) - L;
       integer_intervals_kL7 = [integer_intervals_kL7, interval_kL7];
   end
...
Cov_kh8_7 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL7 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 7 위치 생성
       interval_eL7 = interval_eL0 + random_number_14; 
       interval_eL7(interval_eL7 > (L-1)) = interval_eL7(interval_eL7 > (L-1)) - L;
       integer_intervals_eL7 = [integer_intervals_eL7, interval_eL7];
   end
...
Cov_eh8_7 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L8)
...
integer_intervals_kL8 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 8 위치 생성
       interval_kL8 = interval_kL0 + random_number_15; 
       interval_kL8(interval_kL8 > (L-1)) = interval_kL8(interval_kL8 > (L-1)) - L;
       integer_intervals_kL8 = [integer_intervals_kL8, interval_kL8];
   end
...
Cov_kh8_8 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL8 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 8 위치 생성
       interval_eL8 = interval_eL0 + random_number_15; 
       interval_eL8(interval_eL8 > (L-1)) = interval_eL8(interval_eL8 > (L-1)) - L;
       integer_intervals_eL8 = [integer_intervals_eL8, interval_eL8];
   end
...
Cov_eh8_8 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L9)
...
integer_intervals_kL9 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       interval_kL9(interval_kL9 > (L-1)) = interval_kL9(interval_kL9 > (L-1)) - L;
...
integer_intervals_eL9 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       interval_eL9(interval_eL9 > (L-1)) = interval_eL9(interval_eL9 > (L-1)) - L;
...
integer_intervals_kL9 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 9 위치 생성
       interval_kL9 = interval_kL0 + random_number_16; 
       interval_kL9(interval_kL9 > (L-1)) = interval_kL9(interval_kL9 > (L-1)) - L;
       integer_intervals_kL9 = [integer_intervals_kL9, interval_kL9];
   end
...
Cov_kh8_9 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL9 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 9 위치 생성
       interval_eL9 = interval_eL0 + random_number_16; 
       interval_eL9(interval_eL9 > (L-1)) = interval_eL9(interval_eL9 > (L-1)) - L;
       integer_intervals_eL9 = [integer_intervals_eL9, interval_eL9];
   end
...
Cov_eh8_9 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H8 / L10)
...
integer_intervals_kL10 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       interval_kL10(interval_kL10 > (L-1)) = interval_kL10(interval_kL10 > (L-1)) - L;
...
integer_intervals_eL10 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       interval_eL10(interval_eL10 > (L-1)) = interval_eL10(interval_eL10 > (L-1)) - L;
...
integer_intervals_kL10 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 10 위치 생성
       interval_kL10 = interval_kL0 + random_number_17; 
       interval_kL10(interval_kL10 > (L-1)) = interval_kL10(interval_kL10 > (L-1)) - L;
       integer_intervals_kL10 = [integer_intervals_kL10, interval_kL10];
   end
...
Cov_kh8_10 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL10 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 10 위치 생성
       interval_eL10 = interval_eL0 + random_number_17; 
       interval_eL10(interval_eL10 > (L-1)) = interval_eL10(interval_eL10 > (L-1)) - L;
       integer_intervals_eL10 = [integer_intervals_eL10, interval_eL10];
   end
...
Cov_eh8_10 = length(unique_intervals_eh) / L * 100;
...
LO = 10;
  ...
  if  Cov_kh8_10 >= percentage && Cov_eh8_10 >= percentage
...
n_1 = [0 129 192 336 368 483 651 676] +1;
...
n_2 = [26 156 177 251 274 507 522 566 593 712] +1;
...
for i = 1:size(ff_0, 1)
    ...
    plot(x_range, y_values2a, '-o r', 'LineWidth', 1, 'MarkerSize', 1, 'Color', [red2, green2, blue2]);
    hold on;
    area(x_range, y_values2a, 'FaceColor', [red22, green22, blue22], 'FaceAlpha', 0.4);
    plot(x_range, y_values2a, 'Color', [red2, green2, blue2], 'LineWidth', 1.5);
end
...
hold on;
area(sorted_matrix2(:,1), sorted_matrix2(:,2), 'FaceColor', [red22, green22, blue22], 'FaceAlpha', 0.4);
...
for i = 1:size(hh_0, 1)
    ...
    plot(x_range, y_values4a, '-o r', 'LineWidth', 1, 'MarkerSize', 1, 'Color', [red2, green2, blue2]);
    hold on;
    area(x_range, y_values4a, 'FaceColor', [red22, green22, blue22], 'FaceAlpha', 0.4);
    plot(x_range, y_values4a, 'Color', [red2, green2, blue2], 'LineWidth', 1.5);
end
...
hold on;
area(sorted_matrix4(:,1), sorted_matrix4(:,2), 'FaceColor', [red22, green22, blue22], 'FaceAlpha', 0.4);
