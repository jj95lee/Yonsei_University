...
end_diff = (720 + unique_intervals_kh(1)) - unique_intervals_kh(end);
...
end_diff = (720 + unique_intervals_eh(1)) - unique_intervals_eh(end);
...
x_coords4 = cell(1, HO); % n에 따라 크기가 변하는 셀 배열 생성

for i = 1:HO
    x_coords1{i} = eval(sprintf('integer_intervals_kh%d', i)); % 각 셀에 값을 할당
end
...
x_coords2 = cell(1, LO); % n에 따라 크기가 변하는 셀 배열 생성

for i = 1:LO
    x_coords2{i} = eval(sprintf('integer_intervals_kh%d', i)); % 각 셀에 값을 할당
end
...
x_coords3 = cell(1, HO); % n에 따라 크기가 변하는 셀 배열 생성

for i = 1:HO
    x_coords3{i} = eval(sprintf('integer_intervals_eh%d', i)); % 각 셀에 값을 할당
end
...
x_coords4 = cell(1, LO); % n에 따라 크기가 변하는 셀 배열 생성

for i = 1:LO
    x_coords4{i} = eval(sprintf('integer_intervals_eh%d', i)); % 각 셀에 값을 할당
end
