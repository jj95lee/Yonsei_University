...
Cov_kh7_1 = length(unique_intervals_kh) / L * 100;
...
Cov_eh7_1 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(L2 / H7)
...
Cov_kh7_2 = length(unique_intervals_kh) / L * 100;
...
Cov_eh7_2 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(L3 / H7)
...
Cov_kh7_3 = length(unique_intervals_kh) / L * 100;
...
Cov_eh7_3 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(L4 / H7)
...
Cov_kh7_4 = length(unique_intervals_kh) / L * 100;
...
Cov_eh7_4 = length(unique_intervals_eh) / L * 100;
