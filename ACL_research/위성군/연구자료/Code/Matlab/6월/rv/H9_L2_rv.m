...
Cov_kh9_1 = length(unique_intervals_kh) / L * 100;
...
Cov_eh9_1 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(L2 / H9)
...
Cov_kh9_2 = length(unique_intervals_kh) / L * 100;
...
Cov_eh9_2 = length(unique_intervals_eh) / L * 100;
