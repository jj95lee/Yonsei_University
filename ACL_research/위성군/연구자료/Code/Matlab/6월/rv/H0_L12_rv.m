...
integer_intervals_kh1 = [];
   ...
   for i = 1:length(gg_0)
       ...
       interval_kh0 = start_points1(i) :end_points1(i) ;
...
Cov_eh11 = length(integer_intervals_eh11)/L*100;
...
integer_intervals_kh11 = [];
   ...
   for i = 1:length(gg_0)
       ...
       interval_kh11 = interval_kh0 + random_number_11; 
       interval_kh11(interval_kh11 > (L-1)) = interval_kh11(interval_kh11 > (L-1)) - L;
       integer_intervals_kh11 = [integer_intervals_kh11, interval_kh11];
   end
...
integer_intervals_eh11 = [];
   ...
   for i = 1:length(hh_0)
       ...
       % 고궤도 satellite 11 위치 재생성
       interval_eh11 = interval_eh0 + random_number_11; 
       interval_eh11(interval_eh11 > (L-1)) = interval_eh11(interval_eh11 > (L-1)) - L;
       integer_intervals_eh11 = [integer_intervals_eh11, interval_eh11];
   end
...
Cov_eh12 = length(integer_intervals_eh12)/L*100;
...
integer_intervals_kh12 = [];
   ...
   for i = 1:length(gg_0)
       ...
       interval_kh12 = interval_kh0 + random_number_12; 
       interval_kh12(interval_kh12 > (L-1)) = interval_kh12(interval_kh12 > (L-1)) - L;
       integer_intervals_kh12 = [integer_intervals_kh12, interval_kh12];
   end
...
integer_intervals_eh12 = [];
   ...
   for i = 1:length(hh_0)
       ...
       % 고궤도 satellite 12 위치 재생성
       interval_eh12 = interval_eh0 + random_number_12; 
       interval_eh12(interval_eh12 > (L-1)) = interval_eh12(interval_eh12 > (L-1)) - L;
       integer_intervals_eh12 = [integer_intervals_eh12, interval_eh12];
   end
...
n_2 = random_N(length(random_N)-LO+1:length(random_N));
