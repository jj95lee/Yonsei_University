...
integer_intervals_kh1 = [];
   ...
   % 고궤도 satellite 0 위치 생성
       ...
       interval_kh0(interval_kh0 > 719) = interval_kh0(interval_kh0 > 719) - 720; 
...
integer_intervals_eh1 = [];
   ...
   % 고궤도 satellite 0 위치 생성
       ...
       interval_eh0(interval_eh0 > 719) = interval_eh0(interval_eh0 > 719) - 720; 
...
Cov_eh2 = length(integer_intervals_eh2)/720*100;
...
integer_intervals_eh2 = [];
   ...
   for i = 1:length(ii_0)
       ...
       % 고궤도 satellite 2 위치 재생성
       interval_eh2 = interval_eh0 + random_number_1; 
       interval_eh2(interval_eh2 > 719) = interval_eh2(interval_eh2 > 719) - 720;
       integer_intervals_eh2 = [integer_intervals_eh2, interval_eh2];
   end
...
LO = 1;
  ...
  if  Cov_kh2 >= percentage && Cov_eh2 >= percentage
