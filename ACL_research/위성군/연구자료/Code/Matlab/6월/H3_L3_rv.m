...
Cov_kh3_1 = length(unique_intervals_kh) / L * 100;
...
Cov_eh3_1 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H3 / L2)
...
Cov_kh3_2 = length(unique_intervals_kh) / L * 100;
...
Cov_eh3_2 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H3 / L3)
...
Cov_kh3_3 = length(unique_intervals_kh) / L * 100;
...
Cov_eh3_3 = length(unique_intervals_eh) / L * 100;
...
selected_values_k = unique_intervals_kh(unique_intervals_kh >= 0 & unique_intervals_kh <= 360);
...
LO = 3;
  ...
  if  max(diff_values_k) <= 7 && max(diff_values_e) <= 7
