...
integer_intervals_kL1 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       interval_kL1 = interval_kL0 + random_number_4; 
       interval_kL1(interval_kL1 > (L-1)) = interval_kL1(interval_kL1 > (L-1)) - L;
       integer_intervals_kL1 = [integer_intervals_kL1, interval_kL1];
   end
...
Cov_kh4_1 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL1 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       interval_eL1 = interval_eL0 + random_number_4; 
       interval_eL1(interval_eL1 > (L-1)) = interval_eL1(interval_eL1 > (L-1)) - L;
       integer_intervals_eL1 = [integer_intervals_eL1, interval_eL1];
   end
...
Cov_eh4_1 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H4 / L2)
...
integer_intervals_kL2 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 1 위치 생성
       interval_kL2 = interval_kL0 + random_number_5; 
       interval_kL2(interval_kL2 > (L-1)) = interval_kL2(interval_kL2 > (L-1)) - L;
       integer_intervals_kL2 = [integer_intervals_kL2, interval_kL2];
   end
...
Cov_kh4_2 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL2 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 2 위치 생성
       interval_eL2 = interval_eL0 + random_number_5; 
       interval_eL2(interval_eL2 > (L-1)) = interval_eL2(interval_eL2 > (L-1)) - L;
       integer_intervals_eL2 = [integer_intervals_eL2, interval_eL2];
   end
...
Cov_eh4_2 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H4 / L3)
...
integer_intervals_kL3 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 2 위치 생성
       interval_kL3 = interval_kL0 + random_number_6; 
       interval_kL3(interval_kL3 > (L-1)) = interval_kL3(interval_kL3 > (L-1)) - L;
       integer_intervals_kL3 = [integer_intervals_kL3, interval_kL3];
   end
...
Cov_kh4_3 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eL3 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       integer_intervals_eL2 = [integer_intervals_eL2, interval_eL2];
        ...
        % 저궤도 satellite 2 위치 생성
       interval_eL3 = interval_eL0 + random_number_6; 
       interval_eL3(interval_eL3 > (L-1)) = interval_eL3(interval_eL3 > (L-1)) - L;
       integer_intervals_eL3 = [integer_intervals_eL3, interval_eL3];
   end
...
Cov_eh4_3 = length(unique_intervals_eh) / L * 100;


%% 여기 전까지

end_diff = (L + unique_intervals_eh(1)) - unique_intervals_eh(end);

max_rv_e = max(end_diff, -Inf);


for i = 2:length(unique_intervals_eh)
    diff = unique_intervals_eh(i) - unique_intervals_eh(i-1);
    if diff > max_rv_e
        max_rv_e = diff;
    end
end
...
selected_values_k = unique_intervals_kh(unique_intervals_kh >= 240 & unique_intervals_kh <= 480);

if length(selected_values_k) > 1
    diff_values_k = selected_values_k(2:end) - selected_values_k(1:end-1);
else
    diff_values_k = []; % selected_values가 하나 이하의 값을 가지는 경우 빈 배열 생성
end


selected_values_e = unique_intervals_eh(unique_intervals_eh >= 240 & unique_intervals_eh <= 480);

if length(selected_values_e) > 1
    diff_values_e = selected_values_e(2:end) - selected_values_e(1:end-1);
else
    diff_values_e = []; % selected_values가 하나 이하의 값을 가지는 경우 빈 배열 생성
end
...
LO = 3;
  ...
  if  max_rv_k <= lim_rv/2 && max_rv_e <= lim_rv/2 && max(diff_values_k) < lim_rv/4 && max(diff_values_e) < lim_rv/4
