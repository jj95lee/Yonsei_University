...
gg_00 = ...
[...
45533.90625	45611.83594
51427.44141	51452.34375
57270.76172	57353.37891
129012.5391	129028.3594
134858.6719	134906.7188
140722.3242	140790.2344
...		
];
...
integer_intervals_kh11 = [];
   ...
   % 고궤도 satellite 11 랜덤 위치 생성
       ...
       interval_kh11(interval_kh11 > (L-1)) = interval_kh11(interval_kh11 > (L-1)) - L;
...
integer_intervals_eh11 = [];
   ...
   % 고궤도 satellite 10 랜덤 위치 생성
       ...
       interval_eh11(interval_eh11 > (L-1)) = interval_eh11(interval_eh11 > (L-1)) - L;
...
Cov_kh11 = length(unique_intervals_kh) / L * 100;
...
Cov_eh11 = length(unique_intervals_eh) / L * 100;
...
integer_intervals_kh12 = [];
   ...
   % 고궤도 satellite 12 랜덤 위치 생성
       ...
       interval_kh12(interval_kh12 > (L-1)) = interval_kh12(interval_kh12 > (L-1)) - L;
...
integer_intervals_eh12 = [];
   ...
   % 고궤도 satellite 11 랜덤 위치 생성
       ...
       interval_eh12(interval_eh12 > (L-1)) = interval_eh12(interval_eh12 > (L-1)) - L;
...
Cov_kh12 = length(unique_intervals_kh) / L * 100;
...
Cov_eh12 = length(unique_intervals_eh) / L * 100;
...
integer_intervals_kh13 = [];
   ...
   % 고궤도 satellite 13 랜덤 위치 생성
       ...
       interval_kh13(interval_kh13 > (L-1)) = interval_kh13(interval_kh13 > (L-1)) - L;
...
integer_intervals_eh13 = [];
   ...
   % 고궤도 satellite 13 랜덤 위치 생성
       ...
       interval_eh13(interval_eh13 > (L-1)) = interval_eh13(interval_eh13 > (L-1)) - L;
...
Cov_kh13 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_kh14 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_kh14(interval_kh14 > (L-1)) = interval_kh14(interval_kh14 > (L-1)) - L;
...
integer_intervals_eh14 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_eh14(interval_eh14 > (L-1)) = interval_eh14(interval_eh14 > (L-1)) - L;
...
Cov_kh14 = length(unique_intervals_kh) / L * 100;
...
Cov_eh14 = length(unique_intervals_eh) / L * 100;
...
integer_intervals_kh15 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_kh15(interval_kh15 > (L-1)) = interval_kh15(interval_kh15 > (L-1)) - L;
...
integer_intervals_eh15 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_eh15(interval_eh15 > (L-1)) = interval_eh15(interval_eh15 > (L-1)) - L;
...
Cov_kh15 = length(unique_intervals_kh) / L * 100;
...
Cov_eh15 = length(unique_intervals_eh) / L * 100;
...
integer_intervals_kh16 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_kh16(interval_kh16 > (L-1)) = interval_kh16(interval_kh16 > (L-1)) - L;
...
integer_intervals_eh16 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_eh16(interval_eh16 > (L-1)) = interval_eh16(interval_eh16 > (L-1)) - L;
...
Cov_kh16 = length(unique_intervals_kh) / L * 100;
...
Cov_eh16 = length(unique_intervals_eh) / L * 100;
...
integer_intervals_kh17 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_kh17(interval_kh17 > (L-1)) = interval_kh17(interval_kh17 > (L-1)) - L;
...
integer_intervals_eh17 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_eh17(interval_eh17 > (L-1)) = interval_eh17(interval_eh17 > (L-1)) - L;
...
Cov_kh17 = length(unique_intervals_kh) / L * 100;
...
Cov_eh17 = length(unique_intervals_eh) / L * 100;
...
integer_intervals_kh18 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_kh18(interval_kh18 > (L-1)) = interval_kh18(interval_kh18 > (L-1)) - L;
...
integer_intervals_eh18 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       interval_eh18(interval_eh18 > (L-1)) = interval_eh18(interval_eh18 > (L-1)) - L;
...
Cov_kh18 = length(unique_intervals_kh) / L * 100;
...
Cov_eh18 = length(unique_intervals_eh) / L * 100;
...
integer_intervals_kh19 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       % 고궤도 satellite 18 위치 생성
       interval_kh18 = interval_kh1 + random_number_17; 
       interval_kh18(interval_kh18 > (L-1)) = interval_kh18(interval_kh18 > (L-1)) - L;
       integer_intervals_kh18 = [integer_intervals_kh18, interval_kh18];

       % 고궤도 satellite 19 랜덤 위치 생성
       interval_kh19 = interval_kh1 + n; 
       interval_kh19(interval_kh19 > (L-1)) = interval_kh19(interval_kh19 > (L-1)) - L;
       integer_intervals_kh19 = [integer_intervals_kh19, interval_kh19];
   end
...
result_kh18 = [result_kh18; n, difference_kh];

end

%% E_Satellite Setting(L0 / H19)
...
integer_intervals_eh19 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       % 고궤도 satellite 19 랜덤 위치 생성
       interval_eh19 = interval_eh1 + n; 
       interval_eh19(interval_eh19 > (L-1)) = interval_eh19(interval_eh19 > (L-1)) - L;
       integer_intervals_eh19 = [integer_intervals_eh19, interval_eh19];
   end
...
result_eh18 = [result_eh18; n, difference_eh];

end

%% 공통

result_sum18 = [result_kh18(:,1), result_kh18(:,2) + result_eh18(:,2)];
...
integer_intervals_kh19 = [];
   ...
   % 고궤도 satellite 12 위치 재생성
    ...
    % 고궤도 satellite 13 위치 재생성
       ...
       % 고궤도 satellite 19 위치 재생성
       interval_kh19 = interval_kh1 + random_number_18; 
       interval_kh19(interval_kh19 > (L-1)) = interval_kh19(interval_kh19 > (L-1)) - L;
       integer_intervals_kh19 = [integer_intervals_kh19, interval_kh19];
   end
...
Cov_kh19 = length(unique_intervals_kh) / L * 100;
...
integer_intervals_eh19 = [];
   ...
   % 고궤도 satellite 13 위치 재생성
       ...
       % 고궤도 satellite 19 위치 재생성
       interval_eh19 = interval_eh1 + random_number_18; 
       interval_eh19(interval_eh19 > (L-1)) = interval_eh19(interval_eh19 > (L-1)) - L;
       integer_intervals_eh19 = [integer_intervals_eh19, interval_eh19];
   end
...
Cov_eh19 = length(unique_intervals_eh) / L * 100;
...
integer_intervals_kh20 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       % 고궤도 satellite 19 위치 생성
       interval_kh19 = interval_kh1 + random_number_18; 
       interval_kh19(interval_kh19 > (L-1)) = interval_kh19(interval_kh19 > (L-1)) - L;
       integer_intervals_kh19 = [integer_intervals_kh19, interval_kh19];

       % 고궤도 satellite 20 랜덤 위치 생성
       interval_kh20 = interval_kh1 + n; 
       interval_kh20(interval_kh20 > (L-1)) = interval_kh20(interval_kh20 > (L-1)) - L;
       integer_intervals_kh20 = [integer_intervals_kh20, interval_kh20];
   end
...
result_kh19 = [result_kh19; n, difference_kh];

end

%% E_Satellite Setting(L0 / H20)
...
integer_intervals_eh20 = [];
   ...
   % 고궤도 satellite 13 위치 생성
       ...
       % 고궤도 satellite 20 랜덤 위치 생성
       interval_eh20 = interval_eh1 + n; 
       interval_eh20(interval_eh20 > (L-1)) = interval_eh20(interval_eh20 > (L-1)) - L;
       integer_intervals_eh20 = [integer_intervals_eh20, interval_eh20];
   end
...
result_eh19 = [result_eh19; n, difference_eh];

end

%% 공통

result_sum19 = [result_kh19(:,1), result_kh19(:,2) + result_eh19(:,2)];
...
integer_intervals_kh20 = [];
   ...
   % 고궤도 satellite 12 위치 재생성
    ...
    % 고궤도 satellite 13 위치 재생성
       ...
       % 고궤도 satellite 20 위치 재생성
       interval_kh20 = interval_kh1 + random_number_19; 
       interval_kh20(interval_kh20 > (L-1)) = interval_kh20(interval_kh20 > (L-1)) - L;
       integer_intervals_kh20 = [integer_intervals_kh20, interval_kh20];
   end
...
Cov_kh20 = length(unique_intervals_kh) / L * 100;

end_diff = (L + unique_intervals_kh(1)) - unique_intervals_kh(end);

max_rv_k = max(end_diff, -Inf);

for i = 2:length(unique_intervals_kh)
    diff = unique_intervals_kh(i) - unique_intervals_kh(i-1);
    if diff > max_rv_k
        max_rv_k = diff;
    end
end
...
integer_intervals_eh20 = [];
   ...
   % 고궤도 satellite 13 위치 재생성
       ...
       % 고궤도 satellite 20 위치 재생성
       interval_eh20 = interval_eh1 + random_number_19; 
       interval_eh20(interval_eh20 > (L-1)) = interval_eh20(interval_eh20 > (L-1)) - L;
       integer_intervals_eh20 = [integer_intervals_eh20, interval_eh20];
   end
...
Cov_eh20 = length(unique_intervals_eh) / L * 100;
...
LO = 1;
  ...
  % if  Cov_kh20 >= percentage && Cov_eh20 >= percentage
 if  max_rv_k <= lim_rv/2
...
for i = 1:length(column_data)
    if column_data(i) == 0
        ...
        if current_length > 0
            zero_lengths = [zero_lengths, current_length];
            current_length = 0;
        end
    end
end
...
% 첫 열과 마지막 열을 더하고, 첫 열에 덮어쓰기
zero_lengths(:, 1) = zero_lengths(:, 1) + zero_lengths(:, end);

% 마지막 열 제거
zero_lengths(:, end) = [];

Z = sum(zero_lengths)*120/length(zero_lengths)
