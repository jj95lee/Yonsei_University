...
Cov_eh13 = length(unique_intervals_eh) / 720 * 100;
...
%        interval_kh19(interval_kh19 > 719) = interval_kh19(interval_kh19 > 719) - 720;
...
%        interval_eh19(interval_eh19 > 719) = interval_eh19(interval_eh19 > 719) - 720;
...
% unique_intervals_kh = unique(sort(sum_intervals_kh));
% 
% Cov_kh19 = length(unique_intervals_kh) / 720 * 100;
% 
% %% E_renewal(L0 / H19)
% integer_intervals_eh1 = [];
% integer_intervals_eh2 = [];
...
% unique_intervals_eh = unique(sort(sum_intervals_eh));
% 
% Cov_eh19 = length(unique_intervals_eh) / 720 * 100;
% 
% 
% %% E_renewal(L0 / H19)
% integer_intervals_eh1 = [];
...
%        interval_kh20(interval_kh20 > 719) = interval_kh20(interval_kh20 > 719) - 720;
...
%        interval_eh20(interval_eh20 > 719) = interval_eh20(interval_eh20 > 719) - 720;
...
% unique_intervals_kh = unique(sort(sum_intervals_kh));
% 
% Cov_kh20 = length(unique_intervals_kh) / 720 * 100;
% 
% %% E_renewal(L0 / H20)
% integer_intervals_eh1 = [];
% integer_intervals_eh2 = [];
...
% unique_intervals_eh = unique(sort(sum_intervals_eh));
% 
% Cov_eh20 = length(unique_intervals_eh) / 720 * 100;
% 
% 
% %% E_renewal(L0 / H20)
% integer_intervals_eh1 = [];
