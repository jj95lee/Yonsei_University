...
Cov_kh2_1 = length(unique_intervals_kh) / L * 100;
...
Cov_eh2_1 = length(unique_intervals_eh) / L * 100;


%%
%% K_Satellite Setting(H2 / L2)
...
Cov_kh2_2 = length(unique_intervals_kh) / L * 100;
...
Cov_eh2_2 = length(unique_intervals_eh) / L * 100;
...
LO = 2;
  ...
  if  max(diff_values_k) <= 50 && max(diff_values_e) <= 50
...
xlabel('n');
ylabel('v0j[n]');
title('Access Profile Feb 23 2024 Jan 01 2024 Mar 01 2024');
grid on;
xlim([0, L-1]);
ylim([0, 1]);
