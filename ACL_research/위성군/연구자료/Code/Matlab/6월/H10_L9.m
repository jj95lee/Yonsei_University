...
Cov_kh10_2 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh10_2 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh10_3 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh10_3 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh10_4 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh10_4 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh10_5 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh10_5 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh10_6 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh10_6 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh10_7 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh10_7 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh10_8 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh10_8 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(H10 / L9)
...
integer_intervals_kL9 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 9 위치 생성
       interval_kL9 = interval_kL0 + random_number_18; 
       interval_kL9(interval_kL9 > 719) = interval_kL9(interval_kL9 > 719) - 720;
       integer_intervals_kL9 = [integer_intervals_kL9, interval_kL9];
   end
...
Cov_kh10_9 = length(unique_intervals_kh) / 720 * 100;
...
integer_intervals_eL9 = [];
   ...
   % 저궤도 satellite 1 위치 생성
       ...
       % 저궤도 satellite 9 위치 생성
       interval_eL9 = interval_eL0 + random_number_18; 
       interval_eL9(interval_eL9 > 719) = interval_eL9(interval_eL9 > 719) - 720;
       integer_intervals_eL9 = [integer_intervals_eL9, interval_eL9];
   end
...
Cov_eh10_9 = length(unique_intervals_eh) / 720 * 100;
