...
%100 : 601   366   160   305   504   620   280   645   463   186   318   234    58    94   433   578   607    83   329    15   456   155   476   173   199   540   298   282 23   668   442
...
% n의 배열 507~512(기본)부터
n_2 = [242   608   618   154   593   311   519   224   159   140   343   492   586    67   525   111    40   391    74   373   513   380   304   614    80   603 89   290   120   299    ]+1 ;
    

NumberofSatellite2 = length(n_2);
