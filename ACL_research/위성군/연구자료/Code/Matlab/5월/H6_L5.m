...
Cov_eh1_6 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(L2 / H6)
...
Cov_kh2_6 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh2_6 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(L3 / H6)
...
Cov_kh3_6 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh3_6 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(L4 / H6)
...
Cov_kh4_6 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh4_6 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(L5 / H6)
...
Cov_kh5_6 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh5_6 = length(unique_intervals_eh) / 720 * 100;
...
Cov_eh5_6 
  ...
  if  Cov_kh5_6 >= percentage && Cov_eh5_6 >= percentage
