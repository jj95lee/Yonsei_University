...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum1(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
    % unique_values의 길이가 2보다 작으면 두 번째로 작은 값이 없음
    min_value = unique_values(1);
    second_min_value = min_value; % 모든 값이 동일한 경우
end

% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum1 = result_sum1(...
    result_sum1(:, 2) == min_value | result_sum1(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum2(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum2 = result_sum2(...
    result_sum2(:, 2) == min_value | result_sum2(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum3(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum3 = result_sum3(...
    result_sum3(:, 2) == min_value | result_sum3(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum4(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum4 = result_sum4(...
    result_sum4(:, 2) == min_value | result_sum4(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum5(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum5 = result_sum5(...
    result_sum5(:, 2) == min_value | result_sum5(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum6(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum6 = result_sum6(...
    result_sum6(:, 2) == min_value | result_sum6(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum7(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum7 = result_sum7(...
    result_sum7(:, 2) == min_value | result_sum7(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum8(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum8 = result_sum8(...
    result_sum8(:, 2) == min_value | result_sum8(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum9(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum9 = result_sum9(...
    result_sum9(:, 2) == min_value | result_sum9(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum10(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum10 = result_sum10(...
    result_sum10(:, 2) == min_value | result_sum10(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum11(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum11 = result_sum11(...
    result_sum11(:, 2) == min_value | result_sum11(:, 2) == second_min_value, :);
...
% 두 번째 열에서 가장 작은 값과 두 번째로 작은 값을 찾기
unique_values = unique(result_sum12(:, 2));
if length(unique_values) >= 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
else
...
% 두 번째 열이 가장 작은 값 또는 두 번째로 작은 값인 행 선택
rows_with_min_sum12 = result_sum12(...
    result_sum12(:, 2) == min_value | result_sum12(:, 2) == second_min_value, :);
