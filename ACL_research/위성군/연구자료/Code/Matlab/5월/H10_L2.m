...
Cov_kh1_10 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh1_10 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(L2 / H10)
...
Cov_kh2_10 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh2_10 = length(unique_intervals_eh) / 720 * 100;
...
Cov_eh2_10
  ...
  if  Cov_kh2_10 >= percentage && Cov_eh2_10 >= percentage
