...
Cov_kh1_7 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh1_7 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh2_7 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh2_7 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh3_7 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh3_7 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh4_7 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh4_7 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(L5 / H7)
...
Cov_kh5_7 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh5_7 = length(unique_intervals_eh) / 720 * 100;
...
Cov_eh5_7 
  ...
  if  Cov_kh5_7 >= percentage && Cov_eh5_7 >= percentage
