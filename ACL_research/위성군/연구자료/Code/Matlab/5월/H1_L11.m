...
Cov_kh1 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh1 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(L1 / H1)
...
Cov_eh11_1 
  ...
  if  Cov_kh11_1 >= percentage && Cov_eh11_1 >= percentage
