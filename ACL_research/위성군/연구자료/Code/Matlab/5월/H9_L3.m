...
Cov_kh1_9 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh1_9 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh2_9 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh2_9 = length(unique_intervals_eh) / 720 * 100;


%%
%% K_Satellite Setting(L3 / H9)
...
Cov_kh3_9 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh3_9 = length(unique_intervals_eh) / 720 * 100;
...
Cov_eh3_9
  ...
  if  Cov_kh3_9 >= percentage && Cov_eh3_9 >= percentage
