...
Cov_kh36 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh36 = length(unique_intervals_eh) / 720 * 100;
...
Cov_kh46 = length(unique_intervals_kh) / 720 * 100;
...
Cov_eh46 = length(unique_intervals_eh) / 720 * 100;
...
Cov_eh46
  ...
  if  Cov_kh46 >= percentage && Cov_eh46 >= percentage
