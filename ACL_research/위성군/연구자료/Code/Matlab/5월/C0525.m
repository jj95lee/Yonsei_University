...
if length(unique_values) >= 3
    min_value = unique_values(1);
    second_min_value = unique_values(2);
    third_min_value = unique_values(3);
elseif length(unique_values) == 2
    min_value = unique_values(1);
    second_min_value = unique_values(2);
    third_min_value = second_min_value; % 고유값이 2개만 있는 경우
else
    min_value = unique_values(1);
    second_min_value = min_value; % 고유값이 1개만 있는 경우
    third_min_value = min_value;
end

% Top3 선택
rows_with_min_sum1= result_sum1(...
    result_sum1(:, 2) == min_value | ...
    result_sum1(:, 2) == second_min_value | ...
    result_sum1(:, 2) == third_min_value, :);
