...
%% n의 배열
n = [0   136   579   657   460   483   145   289   331    66   260   391     6   325   585   466   651   184   158   453    87    71   555   255   356] + 1 ;

% [0 242   217   382   167   550   502   576   427]
% [ 0  263   451   490   228   603   114   376   342   564   386]
...
ff_00 = ...
[...
35067.42188	35321.77734
40911.62109	41427.89063
47003.67188	47409.08203
53148.28125	53432.8125
59161.40625	59582.69531
65145.46875	65660.80078
71301.21094	71444.76563
...		
];
...
for i = 1:size(ff_0, 1)
    ...
    start_index_new = 717 + start_index;
    end_index = ff_0(i, 2);

    acp(0:end_index) = 1;
    acp(start_index_new:717) = 1;
    end
end
