...
N = 8;
L = 720;
n = [0  38  76  114  152  189  227  265  303  341  379  417  455  493  531  568  608  644  682];

for k = 0:N-1
semiMajorAxis = 7270140;                                                             
eccentricity = 0;
inclination = 62;                                                                                                                          % degrees
rightAscensionOfAscendingNode = round(L/N*k)/2;
