...
startTime = datetime('2017-02-15 12:00:00');
stopTime = datetime('2017-02-16 12:00:00');
...
eccentricity = 0;
inclination = 50;                                                                            % degrees
rightAscensionOfAscendingNode = 90;                                                          % degrees
argumentOfPeriapsis = 1;                                                                    % degrees
trueAnomaly = 0;                                                                           % degrees
