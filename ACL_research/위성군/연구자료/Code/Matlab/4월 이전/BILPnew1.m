...
L = 720;
f= 0;
% n = [0 417 682 207 466 162 574 671 315 113 709 559 591 71 381 424 640 341];

for k = 0:N-1
semiMajorAxis = 7274140;                                                             
eccentricity = 0;
inclination = 42;                                                                                                                          % degrees
rightAscensionOfAscendingNode = L/N*k/2;
argumentOfPeriapsis = 0;                                                                                                                               % degrees
trueAnomaly = mod(argumentOfPeriapsis+rightAscensionOfAscendingNode*f,360);
