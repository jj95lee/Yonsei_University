...
rightAscensionOfAscendingNode = round(L / N * k, 0)*(360 / L);                                                          % degrees
argumentOfPeriapsis = 98.3;                                                                    % degrees
trueAnomaly = argumentOfPeriapsis + 360 - NP * (360/N * k);                                                                           % degrees
sat(k+1) = satellite(sc,semiMajorAxis,eccentricity,inclination,rightAscensionOfAscendingNode, ...
    argumentOfPeriapsis,trueAnomaly)

storedValues1(k+1) = rightAscensionOfAscendingNode;
storedValues2(k+1) = trueAnomaly;

end

%%
names = sat.Name + " Camera";
cam = conicalSensor(sat,"Name",names,"MaxViewAngle",179.9999999999)
